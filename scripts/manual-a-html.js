/**
 * Convierte MANUAL_USUARIO.md en un HTML autocontenido con las imágenes
...
const archivoMd = path.join(carpetaDocs, 'MANUAL_USUARIO.md');
const archivoHtml = path.join(carpetaDocs, 'MANUAL_USUARIO.html');
...
console.log(`\n✅ Generado: docs/MANUAL_USUARIO.html (${tamano} MB)`);
