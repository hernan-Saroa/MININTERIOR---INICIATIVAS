/**
 * Convierte REGISTRO_CAMBIOS_Y_DESPLIEGUE.md en un HTML autocontenido con las imágenes
 ...
 * Salida: docs/REGISTRO_CAMBIOS_Y_DESPLIEGUE.html
 */
...
const archivoMd = path.join(carpetaDocs, 'REGISTRO_CAMBIOS_Y_DESPLIEGUE.md');
const archivoHtml = path.join(carpetaDocs, 'REGISTRO_CAMBIOS_Y_DESPLIEGUE.html');
...
console.log(`\n✅ Generado: docs/REGISTRO_CAMBIOS_Y_DESPLIEGUE.html (${tamano} MB)`);
